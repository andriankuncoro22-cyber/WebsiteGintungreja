  ...
  return (
    <PrintLayout submission={submission}>
      <p className="mt-3 text-justify leading-normal">
        Yang bertanda tangan di bawah ini Kepala Desa Gintungreja, Kecamatan
      ...
      <p className="mt-2.5 text-justify leading-normal">
        Berdasarkan catatan yang ada di kantor kami, nama tersebut di atas adalah benar-benar warga Desa Gintungreja, Kecamatan Gandrungmangu, Kabupaten Cilacap.
      </p>
