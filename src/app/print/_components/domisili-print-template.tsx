  ...
  return (
    <PrintLayout submission={submission} hideRequesterSignature={true}>
      <p className="mt-3 text-justify leading-normal">
        Yang bertanda tangan dibawah ini, Kepala Desa Gintungreja, Kecamatan
      ...
      <p className="mt-2.5 text-justify leading-normal">
        Adalah benar penduduk Desa Gintungreja, Kecamatan Gandrungmangu, Kabupaten Cilacap dan saat ini berdomisili di :
      </p>
