  ...
  return (
    ...
    >
      <p className="mt-2 text-justify leading-snug">
        Yang bertanda tangan dibawah ini kepala Desa Gintungreja, Kecamatan Gandrungmangu, Kabupaten Cilacap, menerangkan dengan sebenarnya bahwa:
      </p>
      ...
      <p className="mt-2 text-justify leading-snug">
        Orang tersebut di atas adalah benar-benar penduduk Desa Gintungreja, Kecamatan Gandrungmangu, Kabupaten Cilacap.
      </p>
