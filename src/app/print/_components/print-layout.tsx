  ...
  const renderSignatureBlock = (compactSpacing?: boolean) => (
    <div className={cn("flex justify-between text-center items-start", reverseSignatures && "flex-row-reverse")}>
      <div className={cn("w-[40%]", hideRequesterSignature && "invisible")}>
        {reverseSignatures ? (
          <p className="mb-0.5">Gintungreja, {formattedDate}</p>
        ) : (
          <p className="invisible mb-0.5">Gintungreja, 00 Bulan 0000</p>
        )}
        <p>{requesterLabel}</p>
      ...
      <div className="w-[45%]">
        ...
        {signerType === 'sekdes' ? (
          <>
            <p>A.n. Kepala Desa Gintungreja</p>
            <p>Plt. Sekretaris Desa Gintungreja</p>
            <div className={inlineSignatures ? "h-16" : isTight ? "h-11" : compactSpacing ? "h-14" : "h-16"}></div>
            <p className="font-bold underline tracking-wider uppercase">SUKIRNO RAGIL PAMUNGKAS</p>
          </>
        ) : (
          <>
            <p>Kepala Desa Gintungreja</p>
            <div className={inlineSignatures ? "h-16" : isTight ? "h-11" : compactSpacing ? "h-14" : "h-16"}></div>
            <p className="font-bold underline tracking-wider uppercase">SUYANTO</p>
          </>
        )}
      </div>
    </div>
