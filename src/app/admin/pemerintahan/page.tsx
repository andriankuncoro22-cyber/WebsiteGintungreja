  ...
  return (
    <>
      <PageHeader
        ...
        description="Manajemen pengurus Perangkat Desa, BPD, RT/RW, Satuan Linmas, dan Kader Posyandu Desa Gintungreja."
      />
      ...
      <Tabs defaultValue="perangkat" className="w-full space-y-4 sm:space-y-8" onValueChange={(v) => setActiveTab(v as OfficialCategory)}>
        ...
        <TabsContent value="posyandu" className="space-y-4 outline-none">
          <div className="p-3 sm:p-4 bg-rose-50 border border-rose-100 rounded-xl sm:rounded-2xl text-[10px] font-bold text-rose-800 uppercase tracking-widest mb-4 sm:mb-6">
            Kader Posyandu Desa Gintungreja untuk pelayanan kesehatan balita, ibu hamil, dan lansia.
          </div>
          <OfficialTable
        ...
        <TabsContent value="linmas" className="space-y-4 outline-none">
          <div className="p-3 sm:p-4 bg-amber-50 border border-amber-100 rounded-xl sm:rounded-2xl text-[10px] font-bold text-amber-800 uppercase tracking-widest mb-4 sm:mb-6">
            Satuan Perlindungan Masyarakat (Satlinmas) Desa Gintungreja untuk menjaga ketertiban, keamanan, dan perlindungan warga.
          </div>
          <OfficialTable
                ...
                <div className="p-3.5 space-y-2.5 bg-white">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      ...
                      <span className={`inline-block text-[9px] font-bold px-2 py-0.5 rounded-full uppercase tracking-tight ${official.position.toLowerCase().includes('ketua') || official.position.toLowerCase().includes('danton') || official.position.toLowerCase().includes('kepala')
                ...
                return (
                  <React.Fragment key={official.id}>
                    ...
                    <TableRow className="hover:bg-slate-50/80 transition-colors group">
                      ...
                      <TableCell>
                        <span className={`text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-tighter ${official.position.toLowerCase().includes('ketua') || official.position.toLowerCase().includes('danton') || official.position.toLowerCase().includes('kepala')
                            ? 'bg-emerald-100 text-emerald-800'
                            : 'bg-slate-100 text-slate-600'
                          }`}>
                          {official.position}
