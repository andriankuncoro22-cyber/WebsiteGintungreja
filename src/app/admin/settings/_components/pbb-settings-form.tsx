...
export function PbbSettingsForm() {
  ...
  const [contactWhatsApp, setContactWhatsApp] = useState('0882-0052-69185');
    ...
    <Card className="border-border/60 shadow-sm rounded-2xl overflow-hidden">
      ...
      <CardContent className="p-3.5 sm:p-6 pt-3.5 sm:pt-4">
        <form onSubmit={handleSave} className="space-y-3.5 sm:space-y-4">
          ...
          {testResult && (
            <div className={`p-2.5 sm:p-3 rounded-xl text-xs flex items-center gap-2 border ${testResult.success
