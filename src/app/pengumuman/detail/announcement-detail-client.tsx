                  ...
                  <div className="flex flex-wrap items-center gap-4 sm:gap-6 border-b border-slate-100 pb-3 sm:pb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] sm:text-xs font-semibold text-slate-700">{announcement.authorName || 'Pemerintah Desa Gintungreja'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 sm:pt-6 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
                    <div className="flex items-center gap-2.5 sm:gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm font-bold text-slate-600 tracking-tight">Portal Resmi Desa Gintungreja</p>
                      </div>
                    </div>
