    ...
    <div className="flex flex-col min-h-screen bg-background overflow-x-hidden w-full">
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
        <div className="max-w-4xl mx-auto text-center mb-6 sm:mb-12 space-y-2 sm:space-y-4">
          ...
          <p className="text-slate-500 font-bold uppercase text-[9px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.3em] font-sans">Mengenal Struktur Organisasi Desa Gintungreja</p>
        </div>
