          ...
          <main className="lg:col-span-9 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500 font-medium max-w-2xl">
                Pusat informasi persyaratan, standar, dan dokumen administrasi Desa Gintungreja.
              </p>
            </div>
      ...
      <footer className="bg-[#081325] text-slate-400 py-12 border-t border-slate-800/80 mt-auto">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-8 text-[10px] font-bold uppercase tracking-widest text-slate-500">
            © 2026 Pemerintah Desa Gintungreja Digital Portal
          </p>
        </div>
      </footer>
    </div>
        ...
        <div className="space-y-8">
          <div className="p-6 md:p-8 bg-amber-50 border-2 border-dashed border-amber-200 rounded-3xl md:rounded-[2.5rem] flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs md:text-sm font-medium text-amber-700">Seluruh pelayanan administrasi di Desa Gintungreja adalah <strong>GRATIS (Rp. 0,-)</strong>.</p>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {[
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="md:col-span-2 rounded-3xl md:rounded-[2.5rem] bg-white border p-6 md:p-8 flex flex-col justify-center">
            ...
            <p className="text-xs md:text-sm text-slate-600 leading-relaxed font-medium">
              Berdasarkan hasil survei periode terakhir, tingkat kepuasan masyarakat Desa Gintungreja menunjukkan tren positif terutama pada aspek kesopanan petugas dan kecepatan waktu penyelesaian dokumen.
            </p>
          </Card>
        </div>
      );
