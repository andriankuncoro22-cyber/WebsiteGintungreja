...
const defaultRawContacts: ImportantNumberContact[] = [
  ...
  { id: '8', label: 'Puskesmas Gandrungmangu I', number: '082234577980', category: 'kesehatan' },
  { id: '9', label: 'Kadus Gintungreja', number: '082138337494', category: 'wilayah' },
  { id: '10', label: 'Kadus Sidakaya', number: '085282256678', category: 'wilayah' },
  { id: '11', label: 'Kadus Kedungwringin', number: '083113339132', category: 'wilayah' },
  { id: '12', label: 'Kadus Cihaur', number: '085728919021', category: 'wilayah' },
];
              ...
              <CardContent className="p-4 sm:p-8 md:p-10">
                <div className="text-center space-y-1.5 sm:space-y-2.5">
                  ...
                  <div className="flex items-center justify-center gap-1.5 text-slate-400 text-[10px] sm:text-xs font-medium pt-1">
                    ...
                    <span>Jl. Desa Gintungreja No. 1 Kode Pos 53255</span>
                  </div>
                </div>
                ...
                <div className="text-center space-y-2 sm:space-y-3">
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 font-medium max-w-lg mx-auto leading-relaxed">
                    Kontak darurat dan layanan cepat pemerintah desa, keamanan, serta fasilitas kesehatan di Gintungreja.
                  </p>
                  <div className="pt-1">
              ...
              <CardContent className="relative z-10 p-5 sm:p-10 md:p-12 text-center space-y-4 sm:space-y-6">
                <div className="space-y-2">
                  ...
                  <h3 className="text-lg sm:text-2xl md:text-3xl font-extrabold uppercase tracking-tight font-display italic">
                    Nomor Pelayanan Desa Gintungreja
                  </h3>
                </div>
                ...
                <p className="text-[11px] sm:text-xs text-white/70 font-medium max-w-sm mx-auto leading-relaxed">
                  Hubungi nomor di atas untuk informasi bantuan dan konsultasi administrasi Desa Gintungreja.
                </p>
              </CardContent>
            </Card>
          </div>
