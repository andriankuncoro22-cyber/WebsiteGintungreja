...
import { FileText, Download, Eye, Info, Star, ShieldCheck, ClipboardCheck, BarChart, BookOpen, ChevronRight, LibraryBig } from 'lucide-react';
import { Skeleton } from '@/components/ui/skeleton';
import { Badge } from '@/components/ui/badge';

export function PelayananCategoryClient() {
  ...
  const renderHeaderContent = () => {
    ...
    switch (categoryId) {
              ...
              <Card className="rounded-[2rem] border-none shadow-sm bg-primary text-white overflow-hidden">
                ...
                <CardContent className="p-8 pt-0">
                  <p className="text-xl font-medium leading-relaxed italic">
                    "Terwujudnya pelayanan desa yang cepat, transparan, dan akuntabel demi kesejahteraan masyarakat Desa Gintungreja."
                  </p>
                </CardContent>
              </Card>
        ...
        return (
          <Card className="rounded-[3rem] border-none shadow-sm bg-white overflow-hidden mb-10 border-t-8 border-primary">
            <CardContent className="p-12 space-y-8 text-center max-w-3xl mx-auto">
              ...
              <div className="pt-6">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Pemerintah Desa Gintungreja</p>
              </div>
            </CardContent>
          </Card>
        );
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            ...
            <Card className="md:col-span-2 rounded-[2.5rem] bg-white border p-8 flex flex-col justify-center">
              ...
              <p className="text-slate-600 leading-relaxed">
                Berdasarkan hasil survei periode terakhir, tingkat kepuasan masyarakat Desa Gintungreja menunjukkan tren positif terutama pada aspek kesopanan petugas and kecepatan waktu penyelesaian dokumen.
              </p>
            </Card>
          </div>
        );
      case 'survey':
        return (
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-emerald-50 p-10 mb-10 flex flex-col md:flex-row items-center gap-8 border-2 border-emerald-100">
            <div className="flex-1 space-y-4">
              <h3 className="text-2xl font-black uppercase text-emerald-950 font-display italic">Bantu Kami Meningkatkan Layanan</h3>
              <p className="text-emerald-800/80 font-medium">Partisipasi Anda dalam mengisi survey kepuasan sangat berarti bagi perbaikan kualitas pelayanan kami di masa depan.</p>
            </div>
                      ...
                      <TableRow key={docItem.id} className="hover:bg-slate-50 transition-colors group">
                        ...
                        <TableCell className="text-right pr-8">
                          <div className="flex justify-end gap-2">
                            ...
                            <Button variant="ghost" size="icon" className="h-10 w-10 rounded-xl hover:bg-secondary hover:text-white transition-all" onClick={() => handleDownload(docItem.fileId)}>
