    ...
    switch (status) {
      case 'approved':
        return {
          ...
          description: 'Surat pengajuan Anda telah selesai diproses dan sudah bisa diambil ke Pelayanan Desa Gintungreja pada pukul 07.00 WIB s.d 16.00 WIB (Senin s.d Jumat). Terima Kasih.'
        };
      case 'pending':
      case 'processing':
        return {
