...
function SambutanTab({ kadesPhotoUrl, customDesc }: { kadesPhotoUrl?: string; customDesc?: string }) {
  ...
  return (
    <div className="space-y-6 sm:space-y-12">
      <div className="grid md:grid-cols-12 gap-4 sm:gap-8 items-stretch">
        <div className="md:col-span-4 lg:col-span-4">
          <Card className="rounded-2xl sm:rounded-3xl md:rounded-[3rem] overflow-hidden border-none shadow-md sm:shadow-xl bg-white md:sticky md:top-28">
            <div className="aspect-[4/3] sm:aspect-[3/4] relative bg-slate-100">
              <img
                src={imageUrl}
                alt="Kepala Desa Gintungreja"
                className="w-full h-full object-cover object-top sm:object-center"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent" />
            </div>
            <div className="p-3.5 sm:p-6 md:p-8 text-center bg-primary text-white">
              <h3 className="text-base sm:text-xl font-black uppercase tracking-tight font-display italic">SUYANTO</h3>
              <p className="text-[8.5px] sm:text-[10px] font-bold text-white/90 uppercase tracking-[0.2em] sm:tracking-[0.3em] mt-0.5 sm:mt-1">Kepala Desa Gintungreja</p>
            </div>
          </Card>
        </div>
        <div className="md:col-span-8 lg:col-span-8 bg-white p-4 sm:p-6 md:p-14 rounded-2xl sm:rounded-3xl md:rounded-[4rem] border shadow-xs sm:shadow-sm space-y-4 sm:space-y-8">
          <div className="space-y-2 sm:space-y-4">
            <Badge className="bg-amber-50 text-amber-800 font-black uppercase text-[8px] sm:text-[10px] tracking-widest px-2.5 sm:px-4 py-1 sm:py-1.5 border-none shadow-xs">
              Profil Resmi Desa Gintungreja
            </Badge>
            <h2 className="text-xl sm:text-3xl md:text-5xl font-black text-slate-900 leading-tight uppercase font-display italic tracking-tight">
              Tentang <span className="text-primary not-italic">Desa Gintungreja</span>
            </h2>
          ...
          <div className="prose prose-slate max-w-none space-y-2.5 sm:space-y-4 text-slate-700 text-xs sm:text-base leading-relaxed">
            <p className="text-xs sm:text-base leading-relaxed text-slate-600 font-medium italic border-l-3 md:border-l-8 border-secondary pl-3 md:pl-6 py-1 md:py-2">
              &ldquo;Desa Gintungreja merupakan salah satu desa yang berada di bagian selatan wilayah Kecamatan Gandrungmangu, Kabupaten Cilacap, Provinsi Jawa Tengah. Memiliki karakter wilayah perdesaan yang cukup kuat dengan kehidupan masyarakat yang ditopang oleh sektor pertanian, perdagangan, usaha kecil, serta berbagai kegiatan sosial dan budaya masyarakat.&rdquo;
            </p>
            <p>
              Berdasarkan publikasi Badan Pusat Statistik (BPS) Kabupaten Cilacap, Kecamatan Gandrungmangu terdiri atas 14 desa dengan luas wilayah keseluruhan 119,26 km². Desa Gintungreja memiliki luas wilayah sekitar <strong>6,10 km²</strong> atau <strong>5,12 persen</strong> dari luas Kecamatan Gandrungmangu. Jarak Desa Gintungreja ke ibu kota Kecamatan Gandrungmangu sekitar <strong>8 kilometer</strong>, sedangkan jarak ke ibu kota Kabupaten Cilacap sekitar <strong>55 kilometer</strong>.
            </p>
            <p>
              Desa Gintungreja tercatat memiliki <strong>Kode Desa 3301102009</strong> dan <strong>Kode Pos 53254</strong> dengan kantor pemerintahan berkedudukan di Jalan Raya Gatot Subroto No. 1, Kecamatan Gandrungmangu. Dengan semangat gotong royong dan kekayaan potensi agraris, Desa Gintungreja terus melangkah menuju masa depan yang mandiri, sejahtera, dan berdaya saing.
            </p>
          </div>
          <div className="pt-2 sm:pt-4 flex flex-wrap gap-1.5 sm:gap-4">
            {["Gotong Royong", "Pertanian Padi & Palawija", "Produksi Gula Merah", "Tari Sintren & Wayang", "Toleransi Beragama", "Layanan Digital"].map(tag => (
      ...
      {/* 6 PILAR KARAKTERISTIK DESA GINTUNGREJA (2 KOLOM DI MOBILE) */}
      <div className="bg-white p-4 sm:p-8 md:p-14 rounded-2xl sm:rounded-3xl md:rounded-[4rem] border shadow-xs sm:shadow-sm space-y-4 sm:space-y-10">
        <div className="text-center max-w-3xl mx-auto space-y-1.5 sm:space-y-3">
          ...
          <h3 className="text-xl sm:text-3xl md:text-4xl font-black text-slate-900 uppercase font-display italic">
            Identitas & Karakter <span className="text-primary not-italic">Desa Gintungreja</span>
          </h3>
          <p className="text-slate-500 font-medium text-[11px] sm:text-sm">Nilai fundamental yang membentuk jati diri dan modal sosial masyarakat Desa Gintungreja</p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-6">
          {[
            {
              title: 'Sejarah Pemekaran',
              desc: 'Lahir melalui proses pemekaran Desa Cisumur era Kades Sastro Prayitno (1989/1991), menaungi 4 dusun bersejarah.',
              icon: History,
              color: 'text-[#92400E] bg-amber-50 border-amber-200'
            },
            {
              title: 'Filosofi Gintung + Reja',
              desc: 'Gintung (pohon penanda alam) dan Reja (makmur, subur, sejahtera) sebagai doa kemakmuran bagi seluruh warga.',
              icon: Landmark,
              color: 'text-[#C2410C] bg-orange-50 border-orange-200'
            },
            {
              title: 'Pertanian & Agraris',
              desc: 'Mayoritas warga bertani padi dan palawija, membentuk pola hidup bersahaja, rukun, dan berkeadilan sosial.',
              icon: Sprout,
              color: 'text-primary bg-amber-50/80 border-amber-200'
            },
            {
              title: 'Produksi Gula Merah & UMKM',
              desc: 'Keragaman mata pencaharian melalui industri gula merah kelapa, perdagangan sembako, jasa, dan penguatan BUMDes.',
              icon: Store,
              color: 'text-[#B45309] bg-amber-50 border-amber-200'
            },
            {
              title: 'Seni Sintren & Budaya',
              desc: 'Melestarikan kesenian tradisional Tari Sintren, pertunjukan Wayang Kulit ruwat desa, dan Tari Kuda Lumping.',
              icon: Sparkles,
              color: 'text-[#78350F] bg-stone-100 border-stone-200'
            },
            {
              title: 'Tata Kelola & Digital',
              desc: 'Pemerintahan desa terbuka, akuntabel, dan mengadopsi teknologi website untuk kemudahan layanan administrasi warga.',
              icon: ShieldCheck,
              color: 'text-[#854D0E] bg-amber-50 border-amber-200'
            },
          ].map((item, i) => (
      ...
      <div className="bg-gradient-to-br from-primary to-slate-900 p-4 sm:p-8 md:p-14 rounded-2xl sm:rounded-3xl md:rounded-[4rem] text-white shadow-xl space-y-4 sm:space-y-8">
        <div className="max-w-3xl space-y-1.5 sm:space-y-3">
          ...
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed font-medium">
            Pemerintah Desa Gintungreja berkomitmen mewujudkan pemerintahan bersih dan berdaya guna tinggi:
          </p>
        </div>
    ...
    <div className="space-y-6 sm:space-y-10">
      <div className="space-y-2 sm:space-y-3">
        ...
        <p className="text-slate-500 font-medium text-xs sm:text-sm md:text-base border-l-4 border-secondary pl-3 sm:pl-4 uppercase tracking-tight">
          Mengenal Pelayan Masyarakat & Lembaga Desa Gintungreja
        </p>
      </div>
        ...
        <TabsContent value="perangkat" className="space-y-5 sm:space-y-8 focus-visible:outline-none animate-in fade-in-50 duration-300">
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-slate-500 font-semibold">Pemerintah Desa Gintungreja</p>
            </div>
          </div>
          {isLoading ? (
        ...
        <TabsContent value="posyandu" className="space-y-5 sm:space-y-8 focus-visible:outline-none animate-in fade-in-50 duration-300">
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-slate-500 font-semibold">Kader Pelayanan Kesehatan & Posyandu Desa Gintungreja</p>
            </div>
          </div>
          {isLoading ? (
            <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-2 min-[380px]:gap-2.5 md:gap-8">
        ...
        <TabsContent value="linmas" className="space-y-5 sm:space-y-8 focus-visible:outline-none animate-in fade-in-50 duration-300">
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-slate-500 font-semibold">Satuan Perlindungan Masyarakat Desa Gintungreja</p>
            </div>
          </div>
          {isLoading ? (
            <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-2 min-[380px]:gap-2.5 md:gap-8">
...
function SejarahTab() {
  const historyTimeline = [
    {
      period: 'Pra-Pemekaran',
      title: 'Bagian Administratif Wilayah Desa Cisumur',
      desc: 'Sebelum pemekaran, wilayah Desa Cisumur memiliki wilayah yang sangat luas mencakup sembilan dusun: Sidakaya, Gintungreja, Cihaur, Gebangsari, Sidaurip, Kuripan, Balaipanjang, Purwadadi, dan Cisumur.',
      icon: History
    },
    {
      period: '1989 / 1991',
      title: 'Pemekaran Wilayah & Terbentuknya Desa Gintungreja',
      desc: 'Pada masa kepemimpinan Kepala Desa Sastro Prayitno di Desa Cisumur, terjadi penataan wilayah. Wilayah induk Cisumur menyisakan 3 dusun (Balaipanjang, Purwadadi, Cisumur), sedangkan wilayah lainnya dimekarkan menjadi dua desa baru: Desa Gintungreja dan Desa Sidaurip.',
      icon: Landmark
    },
    {
      period: 'Asal-Usul Nama',
      title: 'Filosofi Gintung + Reja: Harapan Kemakmuran',
      desc: 'Berasal dari kata "Gintung" (nama pohon lokal yang menjadi penanda wilayah) dan "Reja" (bahasa Jawa: makmur, subur, ramai, sejahtera). Menjadi doa para pendahulu agar desa senantiasa makmur dan tenteram.',
      icon: Sprout
    },
    {
      period: 'Era Sekarang',
      title: 'Desa Gintungreja: Menjaga Budaya, Membangun Masa Depan',
      desc: 'Kini Desa Gintungreja berdiri kokoh dengan 4 Dusun, 5 RW, 43 RT, dan 7.007 jiwa penduduk (BPS 2024). Ditopang sektor pertanian produktif, UMKM gula merah, seni tradisi Sintren & Wayang Kulit, serta layanan publik digital yang inklusif.',
      icon: TrendingUp
    },
  ];
    ...
    <div className="space-y-6 sm:space-y-16 max-w-4xl mx-auto">
      <div className="text-center space-y-1.5 sm:space-y-4">
        ...
        <h2 className="text-xl sm:text-3xl md:text-5xl font-black text-slate-900 uppercase font-display italic tracking-tight">
          Menelusuri Jejak Berdirinya <span className="text-primary not-italic">Desa Gintungreja</span>
        </h2>
      ...
      <Card className="rounded-2xl sm:rounded-3xl md:rounded-[3rem] border-none shadow-xs sm:shadow-sm bg-white p-4 sm:p-8 md:p-14 space-y-4 sm:space-y-8">
        <div className="inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-[9px] sm:text-xs font-bold uppercase tracking-wider text-amber-800">
        ...
        <div className="prose prose-slate max-w-none text-slate-700 space-y-2.5 sm:space-y-5 text-xs sm:text-base leading-relaxed">
          <p>
            Sejarah Desa Gintungreja tidak dapat dipisahkan dari sejarah perkembangan wilayah Desa Cisumur. Berdasarkan sumber sejarah Desa Cisumur, sebelum terjadi pemekaran, wilayah Desa Cisumur memiliki beberapa dusun yang cukup luas, di antaranya Dusun Sidakaya, Gintungreja, Cihaur, Gebangsari, Sidaurip, Kuripan, Balaipanjang, Purwadadi, dan Cisumur.
          </p>
          <p>
            Pada masa pemerintahan Kepala Desa <strong>Sastro Prayitno</strong>, wilayah Desa Cisumur mengalami pemekaran. Setelah pemekaran tersebut, wilayah Desa Cisumur menyisakan tiga dusun, yaitu Dusun Balaipanjang, Purwadadi, dan Cisumur. Sementara itu, wilayah lainnya berkembang menjadi dua desa baru, yaitu <strong>Desa Gintungreja</strong> dan <strong>Desa Sidaurip</strong>.
          </p>
          <p>
            Dengan demikian, lahirnya Desa Gintungreja merupakan bagian dari proses perkembangan pemerintahan dan penataan wilayah masyarakat yang sebelumnya berada dalam satu wilayah administratif Desa Cisumur.
          </p>

          <div className="p-4 sm:p-6 rounded-2xl bg-amber-50/70 border border-amber-200/80 space-y-2">
            <h4 className="font-bold text-amber-900 text-sm sm:text-base">Catatan Tahun Pembentukan</h4>
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              Mengenai tahun terbentuknya Desa Gintungreja, terdapat perbedaan informasi dalam sumber yang tersedia. Sebuah penelitian akademik yang diterbitkan oleh <em>UIN Prof. K.H. Saifuddin Zuhri Purwokerto</em> menyebut Desa Gintungreja terbentuk pada tahun <strong>1989</strong>. Sementara itu, sumber sejarah lokal menyebut bahwa Desa Gintungreja lahir melalui pemekaran wilayah Desa Cisumur pada tahun <strong>1991</strong> (khususnya berkaitan dengan wilayah Dusun Sidakaya).
            </p>
          </div>
        </div>
        ...
        <div className="pt-4 sm:pt-8 border-t border-slate-100 space-y-3 sm:space-y-6">
          <h3 className="text-base sm:text-2xl font-black text-slate-900 uppercase font-display italic">
            Asal-Usul dan Filosofi Nama <span className="text-primary not-italic">Gintungreja</span>
          </h3>
          <p className="text-slate-600 text-xs sm:text-base leading-relaxed">
            Nama <strong>Gintungreja</strong> dipercaya berasal dari dua kata sarat makna dalam kearifan lokal:
          </p>

          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            <div className="p-3 sm:p-6 rounded-xl sm:rounded-2xl bg-amber-50/80 border border-amber-200 space-y-1 sm:space-y-2">
              <span className="text-[9px] sm:text-xs font-black uppercase text-amber-900 tracking-wider">Gintung</span>
              <p className="text-[10.5px] sm:text-sm font-bold text-slate-800 leading-snug">
                Merujuk pada nama sebuah jenis pohon yang dikenal dan tumbuh di lingkungan masyarakat setempat sebagai penanda alam.
              </p>
            </div>
            <div className="p-3 sm:p-6 rounded-xl sm:rounded-2xl bg-orange-50/80 border border-orange-200 space-y-1 sm:space-y-2">
              <span className="text-[9px] sm:text-xs font-black uppercase text-orange-900 tracking-wider">Reja</span>
              <p className="text-[10.5px] sm:text-sm font-bold text-slate-800 leading-snug">
                Dalam bahasa Jawa mengandung makna <em>makmur, subur, ramai, atau sejahtera</em>.
              </p>
            </div>
          </div>
          ...
          <div className="p-3.5 sm:p-6 rounded-xl sm:rounded-2xl bg-slate-900 text-white space-y-2 sm:space-y-3 shadow-md sm:shadow-lg">
            <p className="text-[9px] sm:text-xs font-bold text-secondary uppercase tracking-widest">Makna Filosofis & Doa Luhur</p>
            <p className="text-xs sm:text-base text-slate-200 leading-relaxed font-medium italic">
              &ldquo;Nama Gintungreja dimaknai sebagai sebuah harapan dan doa dari para pendahulu agar wilayah dan masyarakat yang tinggal di dalamnya senantiasa memperoleh kehidupan yang makmur, sejahtera, subur, tenteram, dan berkembang.&rdquo;
            </p>
            <p className="text-xs sm:text-sm font-black text-amber-200 pt-1.5 sm:pt-2 border-t border-white/10">
              Gintungreja — Merawat Sejarah, Menjaga Budaya, Membangun Masa Depan.
            </p>
          </div>
        </div>
      </Card>
        ...
        <Card className="rounded-2xl sm:rounded-3xl md:rounded-[3rem] overflow-hidden border-none shadow-md sm:shadow-xl h-[260px] sm:h-[450px] md:h-[550px] relative group">
          ...
          <div className="absolute top-3 sm:top-4 md:top-8 left-3 sm:left-4 md:left-8 pointer-events-none z-10">
            <Badge className="bg-primary text-white font-black uppercase text-[7.5px] min-[380px]:text-[8.5px] md:text-[10px] tracking-wider md:tracking-widest px-2.5 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2 rounded-full border-none shadow-xl">
              Peta Geografis Desa Gintungreja
            </Badge>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-3 gap-1.5 sm:gap-4">
          <div className="p-2 min-[380px]:p-2.5 sm:p-6 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-1 sm:space-y-2 flex flex-col justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[8.5px] min-[380px]:text-[9.5px] sm:text-sm font-black text-slate-800 font-mono truncate">-7.586222°, 108.8449°</p>
            </div>
            <a
              href="https://www.google.com/maps?q=-7.586222,108.8449"
              target="_blank"
            ...
            >
              <span>Buka Maps</span> <ArrowRight className="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 shrink-0" />
            </a>
          </div>
          <div className="p-2 min-[380px]:p-2.5 sm:p-6 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1">
            ...
            <p className="text-sm min-[380px]:text-lg sm:text-2xl font-black text-primary font-display">8 KM</p>
          ...
          <div className="p-2 min-[380px]:p-2.5 sm:p-6 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1">
            ...
            <p className="text-sm min-[380px]:text-lg sm:text-2xl font-black text-primary font-display">55 KM</p>
        ...
        <Card className="rounded-2xl sm:rounded-3xl md:rounded-[3rem] border-none bg-primary text-white overflow-hidden shadow-xl">
          <CardContent className="p-4 sm:p-6 md:p-10 space-y-4 sm:space-y-8 md:space-y-10">
            <div className="space-y-1.5 sm:space-y-4">
              <p className="text-[8px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] text-amber-200">Geografis & Batas</p>
              <h3 className="text-xl sm:text-3xl font-display font-semibold italic">Batas Wilayah</h3>
              <p className="text-xs text-slate-200 leading-relaxed font-medium">
                Luas wilayah sekitar <strong>6,10 km²</strong> (± <strong>610 hektare</strong> / 5,12% dari luas Kecamatan Gandrungmangu) dengan batas:
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-5">
              {[
                { dir: 'UTARA', label: 'Desa Layansari' },
                { dir: 'TIMUR', label: 'Desa Bantarsari' },
                { dir: 'SELATAN', label: 'Ds. Ujunggagak / Kec. Kampung Laut' },
                { dir: 'BARAT', label: 'Desa Sidaurip' },
              ].map((item, i) => (
            ...
            <div className="pt-3 sm:pt-6 border-t border-white/10 space-y-2 sm:space-y-3">
              <div className="flex items-center gap-2 sm:gap-3">
                <Compass className="h-4 w-4 sm:h-5 sm:w-5 text-amber-200 shrink-0" />
              ...
              <div className="p-2.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white/10 border border-white/20 font-mono text-[10px] sm:text-xs text-white flex justify-between">
                <span>Luas: 6,10 km²</span>
                <span>± 610 Ha (5,12%)</span>
              </div>
              <p className="text-[10px] text-white/70 italic">
                *Ketinggian rata-rata wilayah ±15 meter di atas permukaan laut.
              </p>
            </div>
          </CardContent>
        </Card>
...
function WilayahTab() {
  const dusuns = [
    { name: '1. DUSUN GINTUNGREJA', desc: 'Pusat pemerintahan desa, pelayanan administrasi terpadu warga, dan sentra kegiatan kemasyarakatan.', color: 'bg-primary' },
    { name: '2. DUSUN SIDAKAYA', desc: 'Wilayah historis cikal bakal pemekaran desa Cisumur dengan permukiman asri dan ketahanan pangan.', color: 'bg-secondary' },
    { name: '3. DUSUN KEDUNGWRINGIN', desc: 'Kawasan permukiman masyarakat dengan kegiatan sosial, keagamaan aktif, dan sarana rabat beton.', color: 'bg-[#92400E]' },
    { name: '4. DUSUN CIHAUR', desc: 'Sentra lahan pertanian produktif, perkebunan rakyat, produksi gula merah, dan infrastruktur jalan desa.', color: 'bg-[#78350F]' },
  ];

  const ageGroups = [
    { group: '0–4 Thn', count: 480, pct: '6.9%' },
    { group: '5–9 Thn', count: 520, pct: '7.4%' },
    { group: '10–14 Thn', count: 545, pct: '7.8%' },
    { group: '15–19 Thn', count: 530, pct: '7.6%' },
    { group: '20–24 Thn', count: 560, pct: '8.0%' },
    { group: '25–29 Thn', count: 590, pct: '8.4%' },
    { group: '30–39 Thn', count: 1120, pct: '16.0%' },
    { group: '40+ Thn', count: 2662, pct: '37.9%' },
  ];

  const schools = [
    'SD Negeri Gintungreja 01',
    'SD Negeri Gintungreja 02',
    'SD Negeri Gintungreja 03',
    'Lembaga Pendidikan Keagamaan, Diniyah & TPQ',
  ];
    ...
    <div className="space-y-6 sm:space-y-16">
      <div className="max-w-3xl space-y-1.5 sm:space-y-4">
        ...
        <p className="text-slate-500 font-medium leading-relaxed text-xs sm:text-sm md:text-base">
          Desa Gintungreja terbagi dalam <strong>4 Dusun</strong>, <strong>5 RW</strong>, dan <strong>43 RT</strong>. Berdasarkan publikasi BPS Kabupaten Cilacap <em>Kecamatan Gandrungmangu Dalam Angka 2025</em>, total penduduk tahun 2024 tercatat <strong>7.007 jiwa</strong> (kepadatan <strong>1.149 jiwa/km²</strong> di atas luas 6,10 km²).
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-1.5 sm:gap-4">
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          ...
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-primary font-display">7.007 <span className="text-[8px] sm:text-xs font-normal">jiwa</span></p>
        </div>
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          <p className="text-[7px] min-[380px]:text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider">Laki-laki</p>
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-[#B45309] font-display">3.596 <span className="text-[8px] sm:text-xs font-normal">jiwa</span></p>
        </div>
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          <p className="text-[7px] min-[380px]:text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider">Perempuan</p>
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-[#C2410C] font-display">3.411 <span className="text-[8px] sm:text-xs font-normal">jiwa</span></p>
        </div>
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          <p className="text-[7px] min-[380px]:text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider">Jumlah Dusun</p>
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-slate-800 font-display">4 Dusun</p>
        </div>
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          <p className="text-[7px] min-[380px]:text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider">RW / RT</p>
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-slate-800 font-display">5 / 43</p>
        </div>
        <div className="p-2 min-[380px]:p-2.5 sm:p-5 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-0.5 sm:space-y-1 text-center sm:text-left">
          <p className="text-[7px] min-[380px]:text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider">Kepadatan</p>
          <p className="text-xs min-[380px]:text-sm sm:text-2xl font-black text-primary font-display">1.149 <span className="text-[7.5px] sm:text-[10px] font-normal">jiwa/km²</span></p>
        </div>
      </div>
      ...
      <div className="space-y-3 sm:space-y-6">
        <h3 className="text-base sm:text-2xl font-black text-slate-900 uppercase font-display italic">
          Wilayah Dusun <span className="text-primary not-italic">Desa Gintungreja</span>
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2.5 sm:gap-6">
          {dusuns.map((dusun, i) => (
      ...
      <div className="grid md:grid-cols-12 gap-4 sm:gap-8">
        ...
        <div className="md:col-span-7 bg-white p-3.5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border shadow-xs sm:shadow-sm space-y-3 sm:space-y-6">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-1.5 sm:p-2.5 bg-amber-50 text-amber-800 rounded-lg sm:rounded-xl">
            ...
            <div>
              ...
              <p className="text-[9px] sm:text-xs text-slate-400 font-bold">Data Kependudukan BPS Tahun 2024</p>
            </div>
          </div>
          <p className="text-[10px] sm:text-xs text-slate-600 leading-relaxed font-medium">
            Komposisi penduduk menunjukkan dominasi jumlah usia muda dan usia produktif sebagai motor utama pembangunan perekonomian dan pertanian desa.
          </p>
        ...
        <div className="md:col-span-5 bg-white p-3.5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border shadow-xs sm:shadow-sm space-y-3 sm:space-y-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] sm:text-xs text-slate-400 font-bold">Fasilitas Pendidikan Resmi Kemendikdasmen</p>
            </div>
          </div>
          ...
          <p className="text-[9.5px] sm:text-[11px] text-slate-500 italic leading-relaxed">
            *Didukung pula oleh kegiatan pendidikan keagamaan, madrasah diniyah, dan TPQ di setiap dusun.
          </p>
        </div>
      </div>
    </div>
...
function PotensiTab() {
  const potentials = [
    {
      title: 'Pertanian & Agraris',
      desc: 'Sektor utama kehidupan masyarakat dengan komoditas padi, palawija, pengelolaan lahan produktif, kelembagaan tani, dan tradisi agraris gotong royong.',
      icon: Sprout,
      color: 'text-[#B45309]',
      bg: 'bg-amber-50'
    },
    {
      title: 'Produksi Gula Merah & UMKM',
      desc: 'Industri rumah tangga pengolahan gula merah (gula kelapa), perdagangan lokal, usaha mikro kecil, peternakan rakyat, dan BUMDes Gintungreja.',
      icon: Store,
      color: 'text-[#C2410C]',
      bg: 'bg-orange-50'
    },
    {
      title: 'Seni Tari Sintren & Wayang',
      desc: 'Warisan seni budaya tradisional Tari Sintren yang berkembang sejak 1990-an, pertunjukan Wayang Kulit untuk ruwat desa, serta Tari Kuda Lumping.',
      icon: Landmark,
      color: 'text-primary',
      bg: 'bg-amber-50'
    },
    {
      ...
      desc: 'Peningkatan konektivitas antarwilayah melalui pembangunan rabat beton di Dusun Cihaur, Kedungwringin, dan jalur strategis perdesaan lainnya.',
      icon: Milestone,
      color: 'text-[#78350F]',
      bg: 'bg-stone-100'
    },
  ...
  return (
    <div className="space-y-6 sm:space-y-16">
      <div className="text-center space-y-1.5 sm:space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-slate-500 font-bold uppercase text-[8.5px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.4em]">Sektor Pertanian, Industri Rumah Tangga Gula Merah, Budaya & Modal Sosial</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-6">
        <div className="p-2 min-[380px]:p-2.5 sm:p-8 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-1.5 sm:space-y-4">
          <div className="p-1.5 sm:p-3 bg-amber-50 text-amber-800 w-fit rounded-lg sm:rounded-2xl shrink-0"><Users className="h-3.5 w-3.5 sm:h-6 sm:w-6" /></div>
          ...
          <p className="text-[8.5px] sm:text-xs text-slate-600 leading-relaxed font-medium line-clamp-3 sm:line-clamp-none">
            Tradisi kebersamaan, kerja bakti lingkungan, dan solidaritas sosial yang senantiasa dipelihara warga desa.
          </p>
        </div>

        <div className="p-2 min-[380px]:p-2.5 sm:p-8 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-1.5 sm:space-y-4">
          <div className="p-1.5 sm:p-3 bg-orange-50 text-orange-800 w-fit rounded-lg sm:rounded-2xl shrink-0"><Heart className="h-3.5 w-3.5 sm:h-6 sm:w-6" /></div>
          <h4 className="text-[10px] sm:text-lg font-black text-slate-900 uppercase font-display line-clamp-2">Harmoni Beragama</h4>
          <p className="text-[8.5px] sm:text-xs text-slate-600 leading-relaxed font-medium line-clamp-3 sm:line-clamp-none">
            Toleransi tinggi antarwarga dengan keberadaan Masjid, Mushala/Langgar, serta Gereja Kristen Protestan yang rukun.
          </p>
        </div>

        <div className="p-2 min-[380px]:p-2.5 sm:p-8 rounded-xl sm:rounded-3xl bg-white border border-slate-100 shadow-xs sm:shadow-sm space-y-1.5 sm:space-y-4">
          <div className="p-1.5 sm:p-3 bg-stone-100 text-stone-800 w-fit rounded-lg sm:rounded-2xl shrink-0"><TrendingUp className="h-3.5 w-3.5 sm:h-6 sm:w-6" /></div>
          <h4 className="text-[10px] sm:text-lg font-black text-slate-900 uppercase font-display line-clamp-2">Layanan Digital</h4>
          <p className="text-[8.5px] sm:text-xs text-slate-600 leading-relaxed font-medium line-clamp-3 sm:line-clamp-none">
            Pemanfaatan website resmi desa untuk transparansi publik, administrasi surat menyurat, dan promosi potensi lokal.
          </p>
        </div>
      </div>
    </div>
