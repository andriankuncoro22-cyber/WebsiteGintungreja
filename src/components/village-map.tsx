...
export function VillageMap() {
  ...
  // Koordinat Geografis Desa Gintungreja, Gandrungmangu, Cilacap (-7.586222, 108.8449)
  const center: [number, number] = [-7.586222, 108.8449];
  const zoom = 15;
        ...
        <Marker position={center}>
          <Popup>
            <div className="text-center p-1 space-y-1">
              <p className="font-black text-slate-900 text-sm">Kantor Desa Gintungreja</p>
              <p className="text-slate-600 text-xs">Jl. Raya Gatot Subroto No. 1, Gandrungmangu, Cilacap 53254</p>
