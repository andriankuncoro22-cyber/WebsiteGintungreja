  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-28">
      <motion.div
        ...
        className="overflow-hidden rounded-[2.5rem] border border-emerald-400/30 bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-900 shadow-[0_30px_80px_rgba(5,150,105,0.25)]"
      >
        <div className="grid gap-0 lg:grid-cols-[auto_1fr_auto] lg:items-stretch">
          ...
          <div className="p-8 text-white sm:p-12 flex flex-col justify-center">
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-emerald-50/90">
              Ajukan seluruh pelayanan administrasi desa secara online melalui Portal Desa Gintungreja, cepat, aman, dan bisa diakses dari mana saja.
            </p>
